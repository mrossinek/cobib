    ...
    def tui(tui, sort_mode):
        ...
        if sort_mode:
            try:
                ...
                LOGGER.debug('Removing previous sort argument: "%s"', tui.list_args[sort_arg_idx+1])
        ...
        if command:
            ...
            if sort_mode:
                try:
                    ...
                    LOGGER.debug('Using sort argument: "%s"', tui.list_args[-1])
                except ValueError:
