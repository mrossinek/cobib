...
from cobib.tui import InputBuffer, TextBuffer, TUI
...
class TestTextBuffer:
    ...
    @pytest.mark.parametrize(['strings', 'expected'], [
        [[''], {'lines': [], 'height': 0, 'width': 0,
                'wrapped': False, 'ansi_map': None}],
        [['test'], {'lines': ['test'], 'height': 1, 'width': 4,
                    'wrapped': False, 'ansi_map': None}],
        [['test\ntest'], {'lines': ['test\ntest'], 'height': 1, 'width': 9,
                          'wrapped': False, 'ansi_map': None}],
        [['test', 'test'], {'lines': ['test', 'test'], 'height': 2, 'width': 4,
                            'wrapped': False, 'ansi_map': None}],
    ])
    ...
    @pytest.mark.parametrize(['width', 'label_column', 'expected'], [
        [20, False, ['Label0  Title0 by', '↪  Author0', 'Label1  Title1 by', '↪  Author1',
                     'Label2  Title2 by', '↪  Author2', 'Label3  Title3 by', '↪  Author3',
                     'Label4  Title4 by', '↪  Author4']],
        [20, True, ['Label0  Title0 by', '↪       Author0', 'Label1  Title1 by', '↪       Author1',
                    'Label2  Title2 by', '↪       Author2', 'Label3  Title3 by', '↪       Author3',
                    'Label4  Title4 by', '↪       Author4']],
        [6, True, ['Label', '↪ 0', '↪ Tit', '↪ le0', '↪ by', '↪ Aut', '↪ hor', '↪ 0', 'Label',
                   '↪ 1', '↪ Tit', '↪ le1', '↪ by', '↪ Aut', '↪ hor', '↪ 1', 'Label', '↪ 2',
                   '↪ Tit', '↪ le2', '↪ by', '↪ Aut', '↪ hor', '↪ 2', 'Label', '↪ 3', '↪ Tit',
                   '↪ le3', '↪ by', '↪ Aut', '↪ hor', '↪ 3', 'Label', '↪ 4', '↪ Tit', '↪ le4',
                   '↪ by', '↪ Aut', '↪ hor', '↪ 4']],
    ])
    ...
    def test_popup(self, caplog, monkeypatch, background):
        ...
        assert [record for record in caplog.record_tuples
                if record[0] in ('MockCursesPad', 'MockTUI')] \
            == expected_log
