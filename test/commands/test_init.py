...
class TestInitCommand(CommandTest):
    ...
    def test_warn_insufficient_config(self, setup, caplog):
        ...
        try:
            ...
            assert ('cobib.commands.init', 30, 'You are about to initialize the git tracking of '
                    'your database, but this will only have effect if you also enable the '
                    'DATABASE/git setting in your configuration file!') in caplog.record_tuples
