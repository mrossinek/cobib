...
class TestDOIParser(ParserTest):
    ...
    def test_from_doi(self, caplog):
        ...
        if ('cobib.parsers.doi', logging.ERROR,
    ...
    def test_invalid_doi(self, caplog):
        ...
        assert ('cobib.parsers.doi', logging.WARNING, "'1812.09976' is not a valid DOI.") \
            in caplog.record_tuples
    ...
    def test_catching_api_error(self, caplog, monkeypatch):
        ...
        assert ('cobib.parsers.doi', logging.ERROR, 'An Exception occurred while trying to query '
                + 'the DOI: 10.1021/acs.chemrev.8b00803.') in caplog.record_tuples
    ...
    def test_dump(self, caplog):
        ...
        assert ('cobib.parsers.doi', logging.ERROR, 'Cannot dump an entry as a DOI.') \
            in caplog.record_tuples
