...
### Added
- CoBib's documentation is now generated by [`pdoc`](https://pdoc3.github.io/pdoc/) and hosted at https://mrossinek.gitlab.io/cobib
- (DEV): the `cobib.database.Database`-Singleton has been added to centrally manage the bibliogahic runtime data (!28)
- a new option `config.database.format.suppress_latex_warnings`
...
[Unreleased]: https://gitlab.com/mrossinek/cobib/-/compare/v2.6.1...master
